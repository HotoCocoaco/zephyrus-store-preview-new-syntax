...
void Set_Particle(int client, int slot)
{
	...
	int iParticle = TF2_SpawnParticle(g_sName[slot][g_iEquipt[client][slot]], clientOrigin, clientAngles, false);
...
stock int TF2_SpawnParticle(char[] sParticle, float vecOrigin[3] = NULL_VECTOR, float flAngles[3] = NULL_VECTOR, bool bActivate = true, int entity = 0, int iControlPoint = 0)
{
	int iParticle = CreateEntityByName("info_particle_system");
