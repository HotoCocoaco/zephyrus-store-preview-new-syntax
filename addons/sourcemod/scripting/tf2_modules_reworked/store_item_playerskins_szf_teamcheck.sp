...
{
	name = "Store - Player Skin Module (SZF)",
...
public int PlayerSkins_Equip(int client, int id)
{
	...
	{
		if(IsPlayerAlive(client) && IsValidClient(client, true) && TF2_GetClientTeam(client)==TFTeam_Red && TF2_GetPlayerClassAsNumber(client)==g_ePlayerSkins[m_iData].iClass)
		{
