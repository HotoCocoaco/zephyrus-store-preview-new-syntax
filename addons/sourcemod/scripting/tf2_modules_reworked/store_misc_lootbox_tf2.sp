...
public Plugin myinfo =
{
	...
	author = "shanapu, nuclear silo, HotoCocoa", // If you should change the code, even for your private use, please PLEASE add your name to the author here
	description = "",
...
public void Lootbox_OnMapStart()
{
	...
	PrecacheSound("ui/item_open_crate.wav", true);
}
...
public Action Timer_Color(Handle timer, DataPack pack)
{
	...
	EmitAmbientSound("ui/item_open_crate.wav", fVec, _, _, _, _, _, _);
